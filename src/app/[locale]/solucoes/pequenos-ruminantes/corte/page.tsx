...
const SEGMENT_KEY = 'smallRuminantsBeef';
const SEGMENT_SLUG = 'pequenos-ruminantes-corte';
...
export default async function PequenosRuminantesCortePage({ params }: PageProps) {
  const { locale } = await params;
